...
def update_precinct_map(selected_metric):
    precinct_df = pd.read_csv('./external_data/final-precinct-dataset.csv')
...
def display_property_details(clickData, price_range, boroughs, property_types, min_beds, min_baths):
    if not clickData:
        return {'display': 'none'}, '', '', '', {}, {}, {}
